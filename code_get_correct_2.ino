...
const int sim808TxPin = 8; // TX du module SIM808
const int sim808RxPin = 7; // RX du module SIM808
...
void setup() {
  ...
  if (sendATCommand("AT+SAPBR=3,1,\"APN\",\"vodanet\"", "OK")) {
...
void loop() {
  ...
  String url = "http://api.mumipoc.komatel.com/login?mon=lukobmo&pwd=1234";
