...
String server = "http://20.8.56.118/api/passagers";
...
String readGPS() {
  ...
  if (index != -1) {
    ...
    reponseGPS = "datetime=" + formattedDatetime + "&latitude=" + latitude + "&longitude=" + longitude;
  }else{
    reponseGPS = "datetime=&latitude=&longitude=";
  }
  return reponseGPS;
}
...
void sendDataToServer(String rfid, String gps) {
  String postData = "idrfid=" + rfid + "&" + gps + "&date_expiration_rfid=2024-12-31&id_agent=2&id_bus=1";
  ...
  delay(3000); // Give it time to send the data
